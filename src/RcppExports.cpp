...
// qatd_cpp_tokens_remap
List qatd_cpp_tokens_remap(const List& texts_, const CharacterVector types_, const IntegerVector ids_);
RcppExport SEXP _quanteda_qatd_cpp_tokens_remap(SEXP texts_SEXP, SEXP types_SEXP, SEXP ids_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const List& >::type texts_(texts_SEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(qatd_cpp_tokens_remap(texts_, types_, ids_));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_quanteda_qatd_cpp_tokens_remap", (DL_FUNC) &_quanteda_qatd_cpp_tokens_remap, 3},
